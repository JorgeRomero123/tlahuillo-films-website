  ...
  return (
    ...
    >
      ...
      <body className="antialiased">
        <a
          href="#servicios"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-sm focus:bg-lens-400 focus:px-4 focus:py-2 focus:text-bg-page focus:outline-none"
        >
          Saltar al contenido
        </a>
        {children}
